...
-- Dumping data for table webshop.cart: ~2 rows (approximately)
...
-- Dumping data for table webshop.users: ~1 rows (approximately)
...
INSERT INTO `users` (`id`, `username`, `email`, `password`, `group_id`, `country_id`, `city`, `street`) VALUES
	...
	(2, 'user1', 'user1@user.com', 'demo', 2, NULL, NULL, NULL);
